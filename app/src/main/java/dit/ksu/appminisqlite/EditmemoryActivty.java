...
public class EditmemoryActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btneditmem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditmemoryActivty.this, "แก้ไขเรียบร้อยแล้ว", Toast.LENGTH_SHORT).show();
                Intent gotomain = new Intent(EditmemoryActivty.this,MainActivity.class);
