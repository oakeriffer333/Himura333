...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            private void searchmem(String s) {
                sqLiteDatabase = openOrCreateDatabase(MemOpenHelper.DBNAME,MODE_PRIVATE,null);
                Cursor cursor = sqLiteDatabase.rawQuery("select * from tbmemory where title like '%"+s+"%' or" + " detail like '%"+s+"%' ",null);
                cursor.moveToFirst();
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoadd = new Intent(MainActivity.this,AddmemoryActivty.class);
    ...
    private void cleartable() {
        SQLiteDatabase sqLiteDatabase = openOrCreateDatabase(MemOpenHelper.DBNAME, MODE_PRIVATE, null);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                alb.setPositiveButton("Edit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent gotoedit = new Intent(MainActivity.this,EditmemoryActivty.class);
